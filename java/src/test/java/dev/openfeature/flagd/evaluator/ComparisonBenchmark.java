 ...
 * at single-thread with context size variations.
 *
 * <p>These benchmarks complement the concurrent comparison in
 * {@link ConcurrentFlagEvaluatorBenchmark} by providing single-threaded
 * measurements that isolate evaluation performance from concurrency effects.
 *
 ...
 *
 * # Run old-vs-new simple only:
 * java -jar target/benchmarks.jar "ComparisonBenchmark.X1_.*"
 *
 * # Run context sweep only:
 * java -jar target/benchmarks.jar "ComparisonBenchmark.X3_.*"
 * </pre>
 */
